...
/// </summary>
public abstract partial class FlowbiteInputBase<TValue> : FlowbiteComponentBase, IDisposable
{
    ...
    protected virtual string? ClassValue
    {
        get
        {
            var fieldClass = FieldBound ? EditContext?.FieldCssClass(FieldIdentifier) : null;
